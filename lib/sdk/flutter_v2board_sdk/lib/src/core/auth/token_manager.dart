...
/// ```
class TokenManager {
  // Use a new key so an auth token saved by the previous XBoard integration
  // is never sent to V2Board as auth_data after an application upgrade.
  static const String _storageKey = 'v2board_auth_data';
