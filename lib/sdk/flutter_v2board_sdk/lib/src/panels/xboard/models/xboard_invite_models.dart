...
bool _inviteStatusFromJson(dynamic value) {
  if (value is bool) return value;
  if (value is num) return value.toInt() == 0;
  return false;
}

int _inviteStatusToJson(bool isActive) => isActive ? 0 : 1;
...
class InviteCode with _$InviteCode {
  const factory InviteCode({
    ...
    required int pv,
    @JsonKey(fromJson: _inviteStatusFromJson, toJson: _inviteStatusToJson)
